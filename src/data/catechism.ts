// Generated from the Android reference sources by scripts/convert-android-data.mjs.
...
export const catechismQuestions = [
  {
  ...
  {
    "answer": "The fifth commandment requireth the preserving the honour, and performing the duties, belonging to everyone in their several places and relations, as superiors, inferiors, or equals.",
    "number": 64,
    "proofs": [
      "Eph. 5:21",
      "1 Pet. 2:17",
  ...
  {
    "answer": "The seventh commandment requireth the preservation of our own and our neighbor's chastity, in heart, speech, and behaviour.",
    "number": 71,
    "proofs": [
      "1 Cor. 7:2-3, 5, 34, 36",
      "1 Pet. 3:2"
